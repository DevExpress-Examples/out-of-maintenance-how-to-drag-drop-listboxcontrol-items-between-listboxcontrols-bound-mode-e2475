...
'			Me.listBoxControl2.DragDrop += New System.Windows.Forms.DragEventHandler(Me.listBoxControl2_DragDrop);
			...
			Me.Name = "Form1"
			Me.Text = "How to drag/drop ListBoxControl Items between ListBoxControls (bound)"
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private Function CreateTable() As DataTable
			...
			t.Columns.Add("Data", GetType(String))
			Return t
		End Function

		Private Sub Form1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
			Dim t1 As DataTable = CreateTable()
			Dim t2 As DataTable = CreateTable()

			For i As Integer = 0 To 9
				If i Mod 2 = 0 Then
					t1.Rows.Add(New Object() {i, "Row " & i.ToString()})
				Else
					t2.Rows.Add(New Object() {i, "Row " & i.ToString()})
				End If
			Next i

			listBoxControl1.DataSource = t1
			listBoxControl1.ValueMember = "ID"
			listBoxControl1.DisplayMember = "Data"

			listBoxControl2.DataSource = t2
			listBoxControl2.ValueMember = "ID"
			listBoxControl2.DisplayMember = "Data"
		End Sub
		...
		Private Sub listBoxControl2_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles listBoxControl2.DragDrop
			...
			Dim row As DataRowView = TryCast(listBoxControl1.SelectedItem, DataRowView)
			TryCast(listBox.DataSource, DataTable).Rows.Add(New Object() {row(0), row(1)})
		End Sub
	End Class
End Namespace
